...
async def get_agent_async():
    ...
    root_agent = LlmAgent(
        ...
        instruction="""You are a friendly and efficient assistant for the Instavibe social app.
...
try:
    ...
    log.error(
        f"RuntimeError during module level initialization (likely nested loops): {e}",
        exc_info=True,
    )
except Exception as e:
    log.error(
        f"Unexpected error during module level initialization: {e}", exc_info=True
    )
