...
![image](a2a-demo-nv/a2a_demo_arch.png)
...
* UV
* Agent servers speaking A2A ([use these samples](samples/python/agents/))
...
4.  Interact with the demo, and add some sample agents which speak A2A:
    ...
    You can ask the demo agent _"What remote agents do you have access to?"_ and there should not be any.
